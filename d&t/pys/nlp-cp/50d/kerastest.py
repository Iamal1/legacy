...
vecmodel = word2vec.Word2Vec.load("./text8v50_sg_t.model")
...
# model.load_weights('mlp_50d_sg.d5')
model.fit(data,labels,batch_size=65,nb_epoch=100,shuffle=True,\
	verbose=2,show_accuracy=True,validation_split=0.1)
# model.save_weights('mlp_50d_sg.d5', overwrite=True)
