...
nb_samples=1000
data=np.random.randint(max_features,size=(nb_samples,maxlen))
labels=np.random.randint(2,size=(nb_samples,1))
# labels = np_utils.to_categorical(labels,2)
...
model.fit(data,labels,batch_size=32,nb_epoch=10,shuffle=True,\
